...
class _LocationDetailsState extends State<LocationDetails> {
  ...
  late Future<({Map<String, dynamic> weather, String street})>
  _weatherDataFuture;
  ...
  void initState() {
    ...
    _weatherDataFuture = () async {
      ...
      return (weather: weather, street: street);
    }();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<({Map<String, dynamic> weather, String street})>(
                                        ...
                                        builder: (context) {
                                          ...
                                          final cond =
                                              (dayInfo['condition']?['text']
                                                  as String?) ??
                                              '';
                                          final iconAsset = _conditionToAsset(
                                            cond,
                                            isDay: true,
                                          );
                                          final label = i == 0
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.separated(
                            ...
                            separatorBuilder: (_, __) =>
                                const SizedBox(width: 8),
                            itemCount: iconSmilePaths.length,
                            itemBuilder: (context, index) => HealthDataCard(
                              iconPath: iconSmilePaths[index],
                              title: titles[index],
